				...
				>
					...
					>
						<liferay-ui:search-container-column-text
							...
							name="name"
							value="<%= HtmlUtil.escape(commerceCatalog.getName()) + " --- " + HtmlUtil.escape(commerceCatalog.getSubCatalog()) + " --- " + HtmlUtil.escape(commerceCatalog.getCatalogDefaultLanguageId())%>"
						/>
